...
\______   \_   _____/\______   \/   _____/\_____  \   \      \  
 |     ___/|    __)_  |       _/\_____  \  /   |   \  /   |   \ 
 |    |    |        \ |    |   \/        \/    |    \/    |    \
 |____|   /_______  / |____|_  /_______  /\_______  /\____|__  /
                  \/         \/        \/         \/         \/ 
                                                               |
\033[1;95m|| Created By 804PERSON
\033[1;94m|| Github.com/804PERSON
\033[0;91mv2.0  \033[0m|| Facebook.804PERSON
...
print ' (\033[0;95m•\033[0m) ACTIVE USER : %s'%(nama);time.sleep(0.03)
...
z = json.loads(r.text)
pen gikut = z['summary']['total_count']
except (KeyError, IOError):
pengikut = '%s-%s'%(M,N)
...
print '\n %s[%s>%s] Yt       : RED-MAFIA'%(N,H,N);time.sleep(0.07)
print '\n %s[%s>%s] Author   : RED-MAFIA(RK).'%(N,H,N);time.sleep(0.07)
print '\n %s[%s>%s] Github   : https://github.com/Red-Mafia'%(N,H,N);time.sleep(0.07)
print '\n %s[%s>%s] Facebook : https://www.facebook.com/ᎡᎬᎠ-ᎷᎪҒᏆᎪ-102896575436747/'%(N,H,N);time.sleep(0.07)
print '\n %s[%s>%s] Fanspage : https://www.facebook.com/ᎡᎬᎠ-ᎷᎪҒᏆᎪ-102896575436747/'%(N,H,N);time.sleep(0.07)
print '\n %s[%s>%s] Watsapp: https://chat.whatsapp.com/KmWJuOGRgVdHrDpMAFaOVi'%(N,H,N);time.sleep(0.07)
print '\n %s[%s>%s] Youtube  : https://youtube.com/channel/UCPOWtzNan9ff-E0RI66Wu2A'%(N,H,N);time.sleep(0.07)
